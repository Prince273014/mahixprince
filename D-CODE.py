"""
    @ the script orignal writen by ---( Mr Prince X Mahima )---
    @ Facebook : https://www.facebook.com/ajay.palar.58
    @ facebook : https://www.facebook.com/ajay.palar.58
    @ WhatsApp : +917318**6411
"""
...
def Banner():
   ...
   \x1b[38;5;196m ██████    \x1b[33;1m██    \x1b[38;5;46m██████  \x1b[34;1m███████ \x1b[38;5;196m██   ██ 
   \x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mDEVELOPER \x1b[1;91m :   \x1b[1;92mMR PRINCE
   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mFACEBOOK \x1b[1;91m  :   \x1b[1;92m𝐓𝐄𝐀𝐌-𝐂𝐘𝐁𝐄𝐑-PRINCE
   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mTOOL TYPE \x1b[1;91m :   \x1b[1;92mPAID XD💚
...
def main():
    ...
    print(Banner())
    Mr Prince = '10000' if choice in ('1', '01') else '100000'
    if Mr Prince == '100000':
        print(f"{x} EXAMPLE {G}:{W} 1000 {G}|{W} 2000 {G}|{W} 5000 {G}|{W} 10000")
        line()
        limit = int(input(f"{ch} LIMIT {G}:{W} "))
        user_ids = generate_user_ids(Mr Prince, limit)
    else:
        user_ids = generate_user_ids(Mr Prince)
    print(Banner())
